...
const marineUpdate = () => {
    ...
    function getMarine () {
        axios.get('http://localhost:8080/api/marine-category/'+marineId).then((res) => {
    ...
    const submitMarine = async(event) => {
        ...
        await axios({
            method: "put",
            url: "http://localhost:8080/api/marine-category/"+marineId,
            data: formData,
                ...
                <form onSubmit={submitMarine} > 
                    <Row key={marineId}>
                        ...
                        <Col lg='4' className='mb-1' >
                            ...
                            <br/>
                            <Input type='file' name="categoryImage" onChange={handleFileSelect}   id="logoMarine" placeholder="Marine Image"  />
                            <br />
